...
var getTemplate = function getTemplate() {
  ...
  var text = placeholder || 'Placeholder default';
  var items = data.map(function (item) {
    ...
    return "\n             <li class=\"select__item ".concat(clazz, "\" data-type='item' data-id=\"").concat(item.id, "\">").concat(item.value, "</li>\n        ");
  });
...
window.s = select;
},{"./select/select":"select/select.js"}],"C:/Users/user/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
